      ...
      <template>
        ...
        >
            ...
            <v-toolbar flat color="">
                <v-toolbar-title class="font-weight-bold">Question</v-toolbar-title>
                <v-divider
                class="mx-4"
                inset
                vertical
                ...
                <v-card>
                    ...
                    <v-container>
                        <v-row>
                            ...
                            <v-col cols="12" sm="6" md="4">
                                <v-text-field v-model="editedItem.question" label="Question Name"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="4">
                                <v-text-field v-model="editedItem.option1" label="Option1"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="4">
                                <v-text-field v-model="editedItem.option2" label="Option2"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="4">
                                <v-text-field v-model="editedItem.option3" label="Option3"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="4">
                                <v-text-field v-model="editedItem.option4" label="Option4"></v-text-field>
                            </v-col>
                            <v-col cols="12" sm="6" md="4">
                                <v-text-field v-model="editedItem.correct_option" label="Correct Option"></v-text-field>
                            </v-col>
